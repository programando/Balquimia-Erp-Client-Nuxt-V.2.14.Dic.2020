<template>
  <div class="bg-gray-100">
    ...
    <div class="-mt-10 mx-6">
      <div>
        <h2 class="text-black text-xl font-bold">Nuestros Servicios</h2>
      </div>

      <div class="md:grid md:grid-cols-3 xl:mx-8">
        <div class="bg-white border mt-4 py-4 hover relative">
          <img
          ...
          <div class="mx-6 my-6">
            <h2 class="text-white uppercase text-xl font-bold">
          ...
          <h3 class="mx-4 py-4 font-bold text-lg">
        ...
        <div class="bg-white border mt-4 py-4 hover relative">
          ...
          <h3 class="mx-4 py-4 -mt-6 font-bold text-lg">
            Programa de limpieza, desinfeccion y mantenimiento preventivo
          </h3>
          <div class="opacity-0 ver-mas">
            <nuxt-link to="/">
    ...
    <div class="bg-gray-900 lg:flex relative ">
      ...
      <div class="hidden lg:block hexa2 w-full">
